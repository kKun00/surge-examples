...
def setrun(claw_pkg='geoclaw'):
    ...
    regions.append([1, 5, clawdata.t0, clawdata.tfinal, -92, -85, 27.5, 33.5]) # More specific domain f/ LaTex domain, minlevel = 1, maxlevel > 3, e.g. Can custommize based on time domain
    ...
    topo_file = topo_file.crop((-91, -79, 22.5, 33.5))
    ...
    rundata.gaugedata.gauges.append([1, -88.154, 30.820,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal]) # Chickasaw Creek, 8737138
    rundata.gaugedata.gauges.append([2, -88.060, 30.650,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal]) # Coast Guard Sector Mobile, 8736897
    rundata.gaugedata.gauges.append([3, -88.045, 30.705, 
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal]) # Mobile State Docks,8738048
    rundata.gaugedata.gauges.append([4, -88.089, 30.565,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal]) # Dog River Bridge, 8735391
    rundata.gaugedata.gauges.append([5, -88.158, 30.377,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal]) # West Fowl River Bridge, 8738043
    rundata.gaugedata.gauges.append([6, -88.159, 30.377,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal]) # East Fowl River Bridge, 8735523
    rundata.gaugedata.gauges.append([7, -88.122, 30.725,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal]) # Bayou La Batre Bridge, 8739803
    rundata.gaugedata.gauges.append([8, -88.085, 30.256, 
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal]) # Dauphin Island, 8735180
    rundata.gaugedata.gauges.append([9, -87.240, 30.433,
 				     rundata.clawdata.t0,
...
def setgeo(rundata):
    ...
    # include this info (9/3/2018 ~ 3 UTC)
    gordon.time_offset = datetime.datetime(2018, 9, 3, 3)
